...
module_dir = os.path.join(__location__, "../src/tariochbctools")
try:
...
try:
    from tariochbctools import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = "tariochbctools-doc"
